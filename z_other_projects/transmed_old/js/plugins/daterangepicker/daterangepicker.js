...
(function (root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        define(['moment', 'z_other_projects/jqry_mobile/jquery.mobile-1.4.2/demos/js/jquery', 'exports'], function (momentjs, $, exports) {
        ...
        var jQuery;
        try {
            jQuery = require('z_other_projects/jqry_mobile/jquery.mobile-1.4.2/demos/js/jquery');
        } catch (err) {

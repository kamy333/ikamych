...
class Article extends DatabaseObject
{
    ...
    public static $fields_numeric = ['id', 'likes', 'is_row', 'num_column', 'num_offset'];
    public static $get_form_element = ['subject_id', 'rank', 'link_txt', 'link', 'photo', 'h3', 'article', 'is_row', 'num_column', 'num_offset', 'likes', 'comment', 'input_date'];
...
//    public static $page_delete = "/public/admin/crud/ajax/delete_ajax.php?class_name=" .__CLASS__;
    ...
    protected static $db_fields = ['id', 'rank', 'subject_id', 'link_txt', 'link', 'photo', 'h3', 'article', 'likes', 'is_row', 'num_column', 'num_offset', 'comment', 'input_date'];
    protected static $required_fields = ['article',];
    protected static $db_field_exclude_table_display_sort = ['subject', 'article_short', 'link_short'];

    protected static $db_fields_table_display_short = ['id', 'rank', 'subject', 'link_txt', 'link_short', 'photo', 'h3', 'article_short'];
    protected static $db_fields_table_display_full = ['id', 'rank', 'subject_id', 'subject', 'link_txt', 'link', 'photo', 'h3', 'article', 'likes', 'is_row', 'num_column', 'num_offset', 'comment', 'input_date'];

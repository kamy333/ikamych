 ...
 * Time: 12:39 AM
 */
class ChatFriendDjamila extends DatabaseObject
{


    public static $chat_header = "Chat Djamila Kamy";

    protected static $table_name = "chat_friend_djam";
...
//     var_dump($target_path) ;
    ...
    public static function chat_users_wrappers()
    {
        ...
        foreach ($users as $user) {
            if ($user->username == 'djamila' || $user->username == 'kamy' || $user->username == 'admin') {

...
class InvoiceActual extends DatabaseObject{
    ...
    protected static $db_fields = ['id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','category_id', 'category','ref_upload','invoice_id','invoiced','comment'];

    protected static $required_fields = ['project_id','start_date','end_date', 'quantity','category_id','unit_price','company_unit_price'];

    protected static $db_fields_table_display_short = ['id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','price','price_company', 'category','invoice_id','invoiced'];

    protected static $db_fields_table_display_full = ['id','project_id', 'project_code','start_date','end_date', 'quantity','unit_price','company_unit_price','price','price_company','category','invoice_id','invoiced'];

    protected static $db_field_exclude_table_display_sort=['price','price_company'];

    public static $fields_numeric=['id','project_id','quantity','unit_price','company_unit_price','category_id'];

    public static $get_form_element=['project_id','category_id','project_code','start_date','end_date','quantity','unit_price','company_unit_price','comment'];
    public static $get_form_element_others=['ref_upload'];
...
//    public static $page_delete="delete_invoice_actual.php";
    ...
    public static $form_class_dependency = ['Category', 'Category1', 'Category2'];

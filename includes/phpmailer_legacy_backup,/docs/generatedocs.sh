...
# rsync -a --delete --exclude ".git" --exclude "phpdoc-cache-*/" --exclude "README.md" phpdoc/ ../../phpmailer_legacy_backup,-docs
# After updating docs, push/PR them to the phpmailer_legacy_backup, gh-pages branch: https://github.com/PHPMailer/PHPMailer/tree/gh-pages

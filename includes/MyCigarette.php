...
class MyCigarette extends DatabaseObject {
    ...
    protected static $db_fields = ['id','cig_date','number_cig','cig_date_time','comment'];

    protected static $required_fields = ['cig_date','number_cig'];

    protected static $db_fields_table_display_short =['id','cig_date','number_cig','cig_date_time','comment'];

    protected static $db_fields_table_display_full = ['id','cig_date','number_cig', 'cig_date_time','comment'];

    protected static $db_field_exclude_table_display_sort=null;

    public static $fields_numeric=['id','number_cig'];


    public static $get_form_element=['number_cig','cig_date','cig_date_time','comment'];

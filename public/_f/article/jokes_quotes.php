...
foreach ($articles as $article) {
    echo "<div class='col-lg-4 col-lg-offset-1' style='background-color: #f1ffff;margin-top: 2em;padding: 2em'>";
...
Un juif s'approche d'eux et leur dit: \"Moins fort SVP, dieu pourrait s’apercevoir qu'il ne nous a pas tous tués";
        ...
        <div class="col-lg-4 col-lg-offset-1" style="background-color: #f1ffff;margin-top: 2em;padding: 2em">
            <?php
            $text = "Moshé Zaoui rencontre Isaac Liberman rehov Yafo à Jérusalem:<br> 
-\"Mais que deviens tu mon ami Isaac ??\" <br>
-\"Je suis toujours dans le prêt à porter et toi Moshé ???\" <br>
-\"eh bien je suis dans les pigeons voyageurs depuis quelques temps.\" <br>
-\"AHHHHHH\" dit Isaac \"et dis moi, ça rapporte ????\" <br>
- \"Écoute, répond Moshé, oui c'est un bon business ... je les vends le matin et ils reviennent le soir !!!!!!!\"";
            echo $text . " " . "<hr>";
            ?>
        </div>
        ...
        <div class="col-lg-4 col-lg-offset-1" style="background-color: #f1ffff;margin-top: 2em;padding: 2em">
            ...
            <?php
            $text = "La différence entre un Goy, un Ashkénaze et un Séfarade ?
<br>Le Goy a une femme et une maîtresse…<br>
Et il aime sa maîtresse…<br>
L’Ashkénaze a une femme et une maîtresse…<br>
Et il aime sa femme…<br><br>
Le Séfarade a une femme et une maîtresse…<br>
Et il aime sa mère ! ! !<br>
Bonnes fêtes aux adeptes du grand livre";
            echo "" . $text . "<hr>";
            ?>
        </div>
...
Une longue discussion polémique s'est développée récemment dans nos colonnes, et se reproduit d'ailleurs régulièrement, à ce propos.<br><br>
...
<br>
A cela s'ajoute la question, non moins controversée, de savoir ce qui appartient à l'authentique humour juif et ce qui relève de l'antisémitisme plus ou moins bien voilé.<br> 
...
<br>
Voici un passage qui résume son point de vue sur l'humour juif:
...
Comme Freud l'a démontré, l'humour n'est pas quelque chose à prendre à la légère.";
        ...
        <div class="col-lg-4 col-lg-offset-1"
            ...
            <?php
            //          $text = "<a href='#'></a>";
            $text = "Simone (Veil), Marceline (Loridan-Ivens) et Hélène (Hausser) sont au Jardin d'Eden, attablées autour de pâtisseries, de thé rare et de bons vins et se marrent comme des bossues depuis des heures. Elles font un tel vacarme que dieu en personne vient s'enquérir de la cause de leur hilarité.<br> 
- On se raconte des blagues sur Auschwitz ! répondent-elles ensemble, entre deux hoquets de fou-rire, s'essuyant les yeux de leurs larmes de joie,<br>
- Sur Auschwitz ?, répond le Tout-puissant, mais ce n'est pas très drôle, voyons, Mesdames !<br>
- Ah bon ? Qu'est ce que t'en sais, toi, répondent-elles en choeur, tu n'étais pas là !";
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-1" style="background-color: #f1ffff;margin-top: 2em;padding: 2em">
                ...
                <?php
                //          $text = "<a href='#'></a>";
                $text = "Il y a quelques années le Hamas avait décidé d’envoyer \"un cadeau\" au Président de l’Etat d’Israël. Il lui a envoyé une belle boite accompagnée d’une carte.<br>
Le président ouvrit la boite et observa qu’elle contenait des crottes de merde.
Sur la carte était écrit : \"Pour vous et le fier peuple d’Israël\".<br>
Le président d’Israël, Monsieur Shimon Peres, personne expérimentée et sage, décida de répondre et d'envoyer au Hamas un très joli paquet accompagné d’une carte.<br>
Les leaders du Hamas furent très surpris de recevoir le paquet ; ils l’ouvrirent avec beaucoup de précautions craignant qu’il ne contienne une bombe.<br>
...
En d’autres termes l’invention technologique la plus avancée,développée en Israël.<br>
Les leaders du Hamas furent très impressionnés.<br>
Ils lisent alors la carte qui disait :<br>
...
heures, Hitler n'arrive pas... Ils commencent à s'inquiéter et l'un dit à l'autre: \"Pourvu qu'il ne lui soit rien arrivé!\"</p>";
            ...
            <div class="col-lg-4 col-lg-offset-1"
                 style="color: darkgoldenrod; background-color: #fffd6c;margin-top: 2em;padding: 2em">
                <?php

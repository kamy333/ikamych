...
<!--                            --><?php //echo $Nav->menu_item('User', 'User t', 'manage_ajax.php', 'admin/crud/ajax'); ?>
                    ...
                    <?php if (User::is_kamy()) { ?>
                        ...
                        ><a href="#" data-toggle="dropdown">Kamy<span class="caret"></span></a>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo $path_public; ?>_f/kamy/foyer_oasis.php">Foyer Oasis Calendar</a></li>
                                <li><a href="<?php echo $path_public; ?>admin/delete_unwanter_user.php">Del unwanted Users</a></li>
                    ...
                    ><a href="#" data-toggle="dropdown">Patrick<span class="caret"></span></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="https://gynous.ikamy.ch/gynous/public/assets/assets_public/index.html">Gynous ikamy</a></li>
                            <li class="divider"></li>
                            <li><a  target="_blank" href="https://app.nearscreen.com/accounts/login/">nearscreen Seatable</a></li>
                            <li><a  target="_blank" href="https://cloud.seatable.io/accounts/login/">Kamran Seatable</a></li>
                            <li><a  target="_blank" href="https://web.nearscreen.com/login/">nearscreen WeWeb</a></li>

                            <li><a  target="_blank" href="https://dashboard.weweb.io/sign-in">WeWeb Dashboard(dev@nearscreen)</a></li>
                            <li><a  target="_blank" href="https://sso.nearscreen.com/admin">aMember</a></li>


                            <li class="divider"></li>
                            <li><a target="_blank" href="https://drive.google.com/file/d/1vxyZDOR2SpJHu6b52aMBSCGfOi3SAwdp/view?usp=share_link">2023-04-19 Loom1</a></li>
                            <li><a  target="_blank" href="https://drive.google.com/file/d/1xYDkNwcXk_PhvI5s-IEgDk-7E53Vqlt0/view?usp=share_link">2023-04-19 Loom2</a></li>
                            <li><a  target="_blank" href="https://drive.google.com/file/d/1QssSm_aK6VmwhYfgDJPYKJu50uVqLa59/view?usp=share_link">2023-04-19 Loom3</a></li>
                            <li><a  target="_blank" href="https://drive.google.com/file/d/15xMqswF-HiS2O6mGlWZUYFygYogs78Ll/view?usp=share_link">2023-04-19 Loom4</a></li>

...
Alain Finkelkraut";
     ...
     $text = "NB/ je connais encore quelques non juifs et quelques juifs qui continuent d'encenser le talent, que dis-je... le \"génie\" (!?) de cette ordure qui se croyait si malin et inventeur d'un style* (*dont on remarque ici d'ailleurs l'extrême pauvreté)...
...
//     $text = "";
//     echo "<pre>" . wordwrap($text, 150, "<br>\n"). "</pre><hr>";;
     echo wordwrap($text, 180, "<br>\n");



     $text = "RAPPEL DE SCHLOMO
Cet écrit de Leon Tolstoi date de 1891!!

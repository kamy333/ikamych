...
INSERT INTO `category` (`id`, `category`, `category_1_id`, `category_1`, `category_2_id`, `category_2`, `unit_price`, `company_unit_price`, `comment`)
VALUES
...
INSERT INTO `chat_friend` (`id`, `user_id`, `username`, `message`, `date`, `img`, `read1`) VALUES
  ...
  (302, '28', 'Captainbraliaji', '<p>Bon je fais un tour sur ton site et je reviens ;)</p>', '2016-09-18 23:20:21', '',
   0),
  (303, '28', 'Captainbraliaji', '<p>J''espère que tu vas bien . Je vais me coucher  </p><p>Je t''embrassse</p>',
   '2016-09-18 23:50:05', '', 0);
...
INSERT INTO `clients` (`id`, `pseudo`, `restricted_list`, `company_name`, `web_view`, `last_name`, `first_name`, `email`, `website`, `address`, `cp`, `city`, `country`, `phone`, `mobile`, `comment`, `liste_rank`, `input_date`)
VALUES
  (1, 'COLLINE', 1, '', 'COLLINE', 'COLLINE', '', NULL, NULL, NULL, NULL, 'Gen', 'Suisse', NULL, NULL, NULL, 1,
   '2015-09-25 07:49:22'),
  (2, 'AUTRES', 1, '', 'AUTRES', 'AUTRES', '', NULL, NULL, NULL, NULL, 'Gen', 'Suisse', NULL, NULL, NULL, 1,
   '2015-09-25 07:49:22'),
  (3, 'Tour_Patient', 1, '', 'Tour Patient', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217',
   'Meyrin', 'Suisse', NULL, NULL, NULL, 2, '2015-09-25 07:49:22'),
  (4, 'Tour_Sang', 0, '', 'Tour Sang', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217',
   'Meyrin', 'Suisse', NULL, NULL, NULL, 3, '2015-09-25 07:49:22'),
  (5, 'Carouge_Sang', 0, '', 'Carouge Sang', 'comptabilit', 'Service', NULL, NULL, 'Avenue J.-D. Maillard 3', '1217',
   'Meyrin', 'Suisse', NULL, NULL, NULL, 4, '2015-09-25 07:49:22'),
  (6, 'BENOIST_FILLE', 0, '', 'BENOIST St', 'BENOIST', 'St', NULL, NULL, 'C', '1231', 'Conches', 'Suisse', NULL, NULL,
   NULL, 200, '2015-09-25 07:49:22'),
  (7, 'BERNASCONI', 0, '', 'BERNASCONI Alexandre', 'BERNASCONI', 'Alexandre', NULL, NULL, 'Chemin des Cr', '1218',
   'le Grand-Saconnex', 'Suisse', NULL, NULL, NULL, 200, '2015-09-25 07:49:22');
...
INSERT INTO `invoice_actual` (`id`, `project_id`, `project_code`, `start_date`, `end_date`, `quantity`, `unit_price`, `company_unit_price`, `category_id`, `category`, `ref_upload`, `invoice_id`, `invoiced`, `comment`)
VALUES
...
INSERT INTO `invoice_send` (`id`, `project_id`, `project_code`, `invoice_date`, `gross_amount`, `vat`, `amount`, `canceled`, `status`, `payment_date`)
VALUES
...
INSERT INTO `myexpense` (`id`, `amount`, `ccy_id`, `rate`, `person_id`, `expense_type_id`, `expense_date`, `comment`, `modification_time`)
VALUES
  (2, '20000.00', 1, '1.00000', 1, 1, '2014-04-14', '<p>Pret difficult&eacute; financi&egrave;re</p>',
   '2016-05-01 21:20:00'),
  ...
  (36, '-1000.00', 1, '1.00000', 1, 3, '2016-07-01',
   '<p>pas v&eacute;rifi&eacute; mais selon ses dires 1000.- vers fin de mois de juin</p>', '2016-07-09 01:43:44'),
  (37, '-50.00', 1, '1.00000', 4, 3, '2016-07-12',
   '<p>en rbt &nbsp; elle voulait que change 600.- m''avait donn&eacute; 650.- donc m''a dit de garder 50.- en guise de rbt</p>',
   '2016-07-12 17:58:58'),
  ...
  (41, '100.00', 1, '1.00000', 6, 1, '2016-08-14',
   '<p>Aujourd''hui 14/8 Castro a emprunt&eacute; chf 100 disant que Martia lui devait de l''argent. la veille d&eacute;part michael.</p>',
   '2016-08-14 18:54:48'),
...
INSERT INTO `my_house_expense` (`id`, `amount`, `ccy_id`, `rate`, `person_id`, `expense_type_id`, `expense_date`, `comment`, `modification_time`)
VALUES
...
INSERT INTO `projects` (`id`, `project_code`, `project_name`, `client_id`, `pseudo`, `start_date`, `end_date`, `closed`, `currency_iso`, `vat`, `comment`, `input_date`)
VALUES
...
ALTER TABLE `to_do_list`
  ADD `web_address` TEXT
  AFTER `todo`;
ALTER TABLE `to_do_list`
  ADD `done` TINYINT UNSIGNED NOT NULL DEFAULT '0'
  AFTER `todo`;
ALTER TABLE `to_do_list`
...
INSERT INTO `transport_clients` (`id`, `pseudo`, `liste_restrictive`, `web_view`, `last_name`, `first_name`, `address`, `cp`, `city`, `country`, `default_price`, `default_depart`, `default_arrivee`, `liste_rank`, `remarque`, `input_date`, `modification_time`, `username`)
VALUES
...
VALUES
  (1, 'admin', '$2y$10$YzYyN2U3MjBkNGQ4MTliOOYg0RfXSbg5pFOVsO1vOeEFamBhPdnYS', 'admin', 'webmaster@ikamy.ch', 'admin',
      1, '', '', '', '', 0, 0, 0, '', '', '', '', '', '', '2015-09-17 21:10:25'),
  (2, 'kamy', '$2y$10$ZDJlYTI1OWU3NjA1ODYxZ.CcW4.WWIlMWs6qVo9KvgjjpaonJR0AC', 'Kamran Nafisspour',
      'nafisspour@bluewin.ch', 'admin', 1, 'Kamran', 'Nafisspour', 'kamy01.JPG', 'dbd8cfa6a2f784bb4cfd4918270b315a', 0,
                                                                                                                     0,
                                                                                                                     0,
  ...
  (5, 'gmail', '$2y$10$Zjk1YzgxMjY1MmU3ODY1Mueclgm6AKXXH4OBRRnoU/WTfvHs7q1uC', 'Kamy employee',
      'kamran.nafisspour@gmail.com', 'visitor', 5, 'Kamran', 'Gmail', 'images-42.jpg', '', 0, 0, 0,
                                                                                           '68 rue des Vollandes',
                                                                                           '1207', 'Geneva',
                                                                                           'Switzerland',
                                                                                           '+41 22 735 01 20',
                                                                                           '+41 79 350 21 32',
                                                                                           '2015-09-17 21:10:25'),
  (6, 'test', '$2y$10$MTI5OWUyNzdiYWEzMjJjO.aOmJYfHzX0QikejYi8qxnA6NrEIGp3q', 'test.sql test.sql', 'test@me.com',
      'visitor', 5, 'test1', 'test', '', '', 0, 0, 0, '', '', '', '', '', '', '2016-04-13 07:37:41'),
...
CREATE VIEW `mycigarette_view_by_day` AS (SELECT
                                            year(`mycigarette`.`cig_date`)      AS `year`,
                                            monthname(`mycigarette`.`cig_date`) AS `month`,
                                            `mycigarette`.`cig_date`            AS `date`,
                                            sum(`mycigarette`.`number_cig`)     AS `total`
                                          FROM `mycigarette`
                                          GROUP BY `mycigarette`.`cig_date` DESC);
...
CREATE VIEW `mycigarette_view_by_month` AS (SELECT
                                              year(`c`.`cig_date`)  AS `year`,
                                              month(
                                                  `c`.`cig_date`)   AS `monthno`,
                                              concat_ws(' ', monthname(`c`.`cig_date`), year(
                                                  `c`.`cig_date`))  AS `month`,
                                              sum(`c`.`number_cig`) AS `total`
                                            FROM `mycigarette` `c`
                                            GROUP BY year(`c`.`cig_date`) DESC,
                                              concat_ws(' ', monthname(`c`.`cig_date`), year(`c`.`cig_date`)) DESC);
...
CREATE VIEW `mycigarette_view_by_year` AS (SELECT
                                             year(`mycigarette`.`cig_date`)  AS `year`,
                                             sum(`mycigarette`.`number_cig`) AS `total`
                                           FROM `mycigarette`
                                           GROUP BY year(`mycigarette`.`cig_date`));
...
CREATE VIEW `transport_model` AS
  SELECT
    ...
    (CASE WHEN (`p`.`week_day_rank_id` = 7)
      THEN `p`.`id` END)                                AS `Dimanche`
  FROM (`transport_clients` `c`
    JOIN `transport_programming_model` `p` ON ((`c`.`id` = `p`.`client_id`)))
...
CREATE VIEW `transport_model_pivot` AS (SELECT
                                        ...
                                        GROUP BY `transport_model`.`heure`, `transport_model`.`pseudo`,
                                          `transport_model`.`web_view`, `transport_model`.`client_id`);
...
CREATE VIEW `transport_model_pivot_visible_no` AS (SELECT
                                                   ...
                                                   GROUP BY `transport_model_visible_no`.`heure`,
                                                     `transport_model_visible_no`.`pseudo`,
                                                     `transport_model_visible_no`.`web_view`,
                                                     `transport_model_visible_no`.`client_id`);
...
CREATE VIEW `transport_model_pivot_visible_yes` AS (SELECT
                                                    ...
                                                    GROUP BY `transport_model_visible_yes`.`heure`,
                                                      `transport_model_visible_yes`.`pseudo`,
                                                      `transport_model_visible_yes`.`web_view`,
...
CREATE VIEW `transport_summary_by_course_date_program` AS
  SELECT DISTINCT
    `transport_programming`.`course_date`                                                                   AS `course_date`,
    ...
    sum((((`transport_programming`.`pseudo` = 'tour_patient') OR (`transport_programming`.`pseudo` = 'tag') OR
          (`transport_programming`.`pseudo` = 'partners') OR (`transport_programming`.`pseudo` = 'mines_icbl') OR
          (`transport_programming`.`pseudo` = 'cash') OR (`transport_programming`.`pseudo` = 'aude') OR
          (`transport_programming`.`pseudo` = 'aloha')) AND ((`transport_programming`.`nom_patient` = '') OR isnull(
        `transport_programming`.`nom_patient`))))                                                           AS `erreur_patients`,
    sum(((`transport_programming`.`pseudo` = 'tour_sang') OR ((`transport_programming`.`pseudo` = 'carouge_sang') AND
                                                              ((`transport_programming`.`bon_no` = '') OR isnull(
                                                                  `transport_programming`.`bon_no`)))))     AS `erreur_sang`,
    sum(((`transport_programming`.`depart` = '') OR isnull(`transport_programming`.`depart`) OR
         (`transport_programming`.`arrivee` = '') OR isnull(`transport_programming`.`arrivee`) OR (((
                                                                                                      `transport_programming`.`pseudo`
                                                                                                      = 'tour_patient')
                                                                                                    OR (
                                                                                                      `transport_programming`.`pseudo`
                                                                                                      = 'tag') OR (
                                                                                                    ...
                                                                                                    (
                                                                                                      ...
                                                                                                      `transport_programming`.`pseudo`
                                                                                                      = 'aloha')) AND ((
                                                                                                                         `transport_programming`.`nom_patient`
                                                                                                                         =
                                                                                                                         '')
                                                                                                                       OR
                                                                                                                       isnull(
                                                                                                                           `transport_programming`.`nom_patient`)))
         OR (`transport_programming`.`pseudo` = 'autres') OR ((`transport_programming`.`pseudo` = 'colline') AND
                                                              ((`transport_programming`.`pseudo_autres` = '') OR
                                                               isnull(`transport_programming`.`pseudo_autres`))) OR
         (`transport_programming`.`pseudo` = 'tour_sang') OR ((`transport_programming`.`pseudo` = 'carouge_sang') AND
                                                              ((`transport_programming`.`bon_no` = '') OR isnull(

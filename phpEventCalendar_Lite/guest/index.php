                ...
                <div id="my-calendars" class="panel panel-default" style="margin-top: 10px; margin-left: 3px;">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="width: 100%">My Calendars <span id="add-calendar"
                                                                                       ...
                                                                                       style="float: right; margin-left: 8px;"></span>&nbsp;<span
                                    id="manage-calendar" class="glyphicon glyphicon-cog"
                                    style="margin-top:1px; float: right; cursor: pointer;"></span></h3>
                    </div>
                    <div class="list-group">
                        ...
                        <?php if ($allCalendars != NULL) foreach ($allCalendars as $k => $v) { ?>
                            ...
                            <a href="javascript:void(0);"
                               class="list-group-item ladda-button <?php echo $activeClass ?>" data-style="expand-right"

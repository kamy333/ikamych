                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group col-sm-12 event-image" alt="No Image">
                                <img id="image-src" src=""
                                     style='height: 200px; width: auto; border:1px dotted #d9d9d9; margin: 0 auto;'>
                            </div>


                            <div class="form-group" id="desc_msg">
                                <div class="col-sm-12">
                                    <div class="guest-view" id="description" name="description"
                                         style="height: auto; width: 95%;"></div>
                                </div>
                            </div>
                            ...
                            <div class="event-details col-sm-12">
                                <div class="col-sm-4">
                                    <h6>Start</h6>
                                    <div class="input-group col-sm-4" data-date="" data-date-format="yyyy-mm-dd"
                                         data-link-field="start" data-link-format="yyyy-mm-dd">
                                        <input type="text" class="form-control guest-view" id="start-date-guest"
                                    ...
                                    <div id="end-group">
                                        <h6>End</h6>
                                        <div class="input-group col-sm-4" data-date="" data-date-format="yyyy-mm-dd"
                                             data-link-field="end" data-link-format="yyyy-mm-dd">
                                            <input type="text" class="form-control guest-view" placeholder="End Date"
                                                   name="end-date" id="end-date-guest"/>
                                        </div>
                                        <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group" id="loc_msg">
                                        <h6>Venue</h6>
                                        <p>
                                            <input type="text" class="form-control guest-view" id="location"

    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div style="margin: 2px 20px 0px 4px; float: right; display: none" id="remove-block">
                <button type="button" class="btn btn-danger btn-xs ladda-button" data-style="expand-left"
                        data-event-id="" id="remove-link"><span class="ladda-label">Remove This Event</span></button>
            </div>
                ...
                <div class="modal-body" style="padding-top: 10px">
                    <fieldset>
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group col-sm-6 date form_date" data-date=""
                                         data-date-format="yyyy-mm-dd" data-link-field="start"
                                    ...
                                    <div class="col-sm-3">
                                        <input name="start-time" id="start-time" class="form-control"
                                               readonly="readonly" style="background-color: white; cursor: default;"/>
                                ...
                                <div class="form-group" id="end-group">
                                    ...
                                    <div class="input-group col-sm-6 form_date" data-date=""
                                         data-date-format="yyyy-mm-dd" data-link-field="end"
                                         data-link-format="yyyy-mm-dd">
                                        <input type="text" class="form-control" placeholder="End Date" name="end-date"
                                               id="end-date" readonly="readonly"
                                               style="background-color: white; cursor: default;"/>
                                        <span class="input-group-addon"><span
                                                    class="glyphicon glyphicon-calendar"></span></span>
                                    </div>
                                    <div class="col-sm-3">
                                        <input name="end-time" id="end-time" class="form-control" readonly="readonly"
                                               style="background-color: white; cursor: default;"/>
                        ...
                        <div class="well well-sm" style="margin-top: 10px">
                            ...
                            <div class="form-inline standard" style="float: right; padding-bottom:3px">
                                <div class="checkbox" style="padding-top: 0; float: right; ">
                                    <label for="hide-standard-settings" style="padding-right: 5px; ">
                                        <a href="javascript:void(0);" id="hide-standard-settings">Hide Standard
                                            Settings</a>
                                    </label>
                                </div>
                            </div>
                            ...
                            <!-- Repeat Box -->
                            <div class="panel panel-info repeat-box col-sm-12"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select id="select-calendar"
                                                class="selectpicker show-tick col-lg-12 select-calendar-cls"
                                            ...
                                            <?php if ($allCalendars != NULL) foreach ($allCalendars as $k => $v) { ?>
                                                ...
                                                ?>
                                                <option data-color="<?php echo $v['color'] ?>" <?php echo $active ?>
                                                        value="<?php echo $v['id'] ?>"
                                                        data-content='<span class="multiple-select-option-label"><?php echo htmlspecialchars($v['name'], ENT_QUOTES); ?></span>'><?php echo htmlspecialchars($v['name'], ENT_QUOTES); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-control" style="padding-bottom: 2px;;white-space:nowrap">
                                            <span style="background-color: #3a87ad" class="color-box color-box-selected"
                                                  data-color="#3a87ad" id="cid_3a87ad">&nbsp;✔</span>
                                            <span style="background-color: #eaff00" class="color-box"
                                                  data-color="#eaff00" id="cid_eaff00">&nbsp;</span>
                                            <span style="background-color: #f903a5" class="color-box"
                                                  data-color="#f903a5" id="cid_f903a5">&nbsp;</span>
                                            <span style="background-color: #1a9b05" class="color-box"
                                                  data-color="#1a9b05" id="cid_1a9b05">&nbsp;</span>
                                            <span style="background-color: #0c2ddd" class="color-box"
                                                  data-color="#0c2ddd" id="cid_0c2ddd">&nbsp;</span>
                                            <span style="background-color: #ff4206" class="color-box"
                                                  data-color="#ff4206" id="cid_ff4206">&nbsp;</span>
                                            <span style="background-color: #17cccc" class="color-box"
                                                  data-color="#17cccc" id="cid_17cccc">&nbsp;</span>
                                            <span style="background-color: #0a0003" class="color-box"
                                                  data-color="#0a0003" id="cid_0a0003">&nbsp;</span>
                                            <span style="background-color: #a8a8a8" class="color-box"
                                                  data-color="#a8a8a8" id="cid_a8a8a8">&nbsp;</span>
                                        </div>
                            ...
                            <div class="form-inline reminder" style="float: right; padding-bottom:3px">
                                <div class="checkbox" style="padding-top: 0; float: right; ">
                                    <label for="hide-reminder-settings-settings" style="padding-right: 5px; ">
                                        <a href="javascript:void(0);" id="hide-reminder-settings">Hide Reminder
                                            Settings</a>
                                    </label>
                                </div>
                            </div>

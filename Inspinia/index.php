...
if (User::is_kamy()) {
    ...
    $text1 .= "<p>Maman bozorgue | Katy Samak | Farad Lavi | Maggy Herzet | Dahidjan Ezatollah | Dahidjan Ramatollah | Baba bozorgue | Maman bozorgue | khaleh Aghdass | Dahidjan 3 | Amouh Aziz </p>";
    echo "" . $text1;// . "<hr>";
    $text1 .= "</div>";
    $text1 .= "</div>";
}

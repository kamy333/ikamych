...
<div data-role="page">
    ...
    <div data-role="content">
        ...
        <h2 class="pageTitle"><span>Thumbnail List</span></h2>
        ...
        <div class="content-padd">
            ...
            <div class="padd">
                <div class="thumbnail-list">
                    ...
                    <ul data-filter-placeholder="Search..." data-filter="true" data-role="listview"
                        data-filter-theme="d">
    ...
    <div data-role="footer">
        <div data-role="navbar" class="custom-icons">
            <ul>
                ...
                <li><a href="portfolio.php" id="monitor" data-icon="custom" data-theme="b"
